...
class CNN(Module):
  ...
  def __init__(self, channels, dim, classes):
    ...
    fully_connected_input_size = self.fully_connected_input_dim(dim, final_out_channels)
  ...
  def fully_connected_input_dim(self, square_dim, final_out_channels, num_pools=3):
      """
